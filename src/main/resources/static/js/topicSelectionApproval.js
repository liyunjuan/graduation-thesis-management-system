function topicSelectionApproval() {
    ...
    var toolbar = [
        {
            ...
            handler: function () {
                ...
                if (selectedRow.length > 0) {
                    ...
                    titleDWR.updateStateByBatch(paperTitleIds, 5, function (msg) {
                        if (msg)
        ...
        },
        {
            ...
            handler: function () {
                ...
                if (selectedRow.length > 0) {
                    ...
                    titleDWR.updateStateByBatch(paperTitleIds, 2, function (msg) {
                        if (msg)
    ...
    titleDWR.findByTitleState(4, oPage.pageIndex, oPage.pageSize, function (oData) {
        $('#topicSelectionApprovaldg').datagrid('loading');
