...
@Service
public class PaperGuidancerecordServiceImpl implements PaperGuidancerecordService<PaperGuidancerecord> {
    ...
    public boolean save(PaperGuidancerecord obj) {
        try {
            this.paperGuidancerecordDAO.save(obj);
            return true;
    ...
    public boolean updateWithTitleId(int titleId, PaperGuidancerecord paperGuidancerecord) {
        try {
            ...
            paperGuidancerecord1.setGuidanceDate(paperGuidancerecord
                    .getGuidanceDate());
            this.paperGuidancerecordDAO.merge(paperGuidancerecord1);
    ...
    public boolean update(PaperGuidancerecord obj) {
        try {
            this.paperGuidancerecordDAO.merge(obj);
            return true;
        } catch (PaperManagerException e) {
            e.printStackTrace();
        }
    ...
    public List findWithTitleId(int titleId) {
        try {
            return find(
                    "select new net.dqsy.papermg.papermanager.po.PaperGuidancerecord(guidId,guidance,guidanceType,guidanceDate) from PaperGuidancerecord where paperTitle.paperTitleId = " +
    ...
    public PaperGuidancerecord findById(int id) {
        try {
            return this.paperGuidancerecordDAO.findOne(id);
        } catch (PaperManagerException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public PagingSupport findByProperty(String property, String value, int numberOfPage, int countOfPage) {
        try {
            return this.paperGuidancerecordDAO.findByProperty("PaperGuidancerecord", property, value, numberOfPage, countOfPage);
        } catch (PaperManagerException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public PagingSupport findAll(int numberOfPage, int countOfPage) {
        try {
            return this.paperGuidancerecordDAO.findAll("PaperGuidancerecord", numberOfPage, countOfPage);
        } catch (PaperManagerException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public boolean del(PaperGuidancerecord  obj) {
        try {
            this.paperGuidancerecordDAO.delete(obj);
            return true;
        } catch (PaperManagerException e) {
            e.printStackTrace();
        }
