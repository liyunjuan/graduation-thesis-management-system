...
@Service
public class PaperApplyServiceImpl implements PaperApplyService<PaperApply> {
    ...
    public boolean save(PaperApply o) {
        try {
            this.paperApplyDAO.save(o);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public boolean update(PaperApply o) {
        try {
            this.paperApplyDAO.merge(o);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public PaperApply findById(int id) {
        try {
            return this.paperApplyDAO.findOne(id);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public PagingSupport findByProperty(String property, String value, int numberOfPage, int countOfPage) {
        try {
            return this.paperApplyDAO.findByProperty("PaperApply", property, value, numberOfPage, countOfPage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public PagingSupport findAll(int numberOfPage, int countOfPage) {
        try {
            return this.paperApplyDAO.findAll("PaperApply", numberOfPage, countOfPage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public boolean del(PaperApply o) {
        try {
            this.paperApplyDAO.delete(o);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
        }
