            ...
            .post(
                    ...
                    function (list) {
                        if (list == null || list == '')
                            ...
                            $('#uploadPaperTemplateTable')
                                    .prepend(
                                            '<tr><td colspan="2" style="font-size: 20px; color: red; padding-left: 20px;">当前论文模板为：</td></tr><tr><td colspan="2" style="text-align: center;"><a style="font-size: 15px;" href="../struts/getPaperTemplate.controller">'
                                            + list + '</a></td></tr>');
