                    ...
                    <ul class="sub-menu">
                        ...
                        <c:forEach items="${userRole.paperRole.paperRolePermissions}"
                            ...
                            <li><a href="javascript:void(0)"
                                   onclick="top.mainFrame.addPaperTab('${rolePermission.paperPermission.description}','${rolePermission.paperPermission.permission}')"><em><%=++i%>
                            </em>${rolePermission.paperPermission.description}</a></li>
                        </c:forEach>
                    </ul>
                </c:if></li>
        </c:forEach>
