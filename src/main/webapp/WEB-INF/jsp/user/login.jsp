        ...
        <div class="log_mainbody">
            ...
            <div class="log_right">
                <form id="myform" name="myform" action="/user/login" method="post">
                    ...
                    <label id="checkCodeMsg" style="color: red;">${checkCodeError}</label> &nbsp;&nbsp; <a style="cursor: pointer;"
                                                                                                           onClick="myReload()">看不清？换张图片</a><br/>
                    <br/>
                    <button
                            ...
                            tabindex="5" onclick="return checkLogin()">登 录
                    </button>
                </form>
            </div>
        </div>
